theory ExtraInv8_VC362
  imports ExtraInv8
begin

theorem extra362: "VC362 extraInv8 env s0 PdOut_value paid_value opened_value"
  apply(unfold VC362_def extraInv8_def)
  apply rule+
   apply simp
  apply(erule conjE)
...
theorem "VC410 extraInv8 env s0 PdOut_value paid_value opened_value"
