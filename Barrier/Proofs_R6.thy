...
theorem extra1: "VC1 extraInv s0"
  apply(unfold VC1_def extraInv_def commonExtraInv_def P5_2inv_def always2_inv_def always_def constrained_always_inv_def)
  apply auto
  done
...
theorem extra5: "VC5 extraInv env s0 carInFront'value peCarUnder'value opened'value closed'value"
...
theorem extra6: "VC6 extraInv env s0 carInFront'value peCarUnder'value opened'value closed'value"
...
theorem extra7: "VC7 extraInv env s0 carInFront'value peCarUnder'value opened'value closed'value"
...
theorem "VC1 inv6 s0"
  apply(unfold VC1_def inv6_def R6_def P5_2_def always2_def always_def constrained_always_def)
  using extra1 VC1_def  apply auto
  done

theorem  "VC2 inv6 env s0 carInFront'value peCarUnder'value opened'value closed'value"
  apply(unfold VC2_def inv6_def R6_def)
  apply(rule impI)
...
theorem  "VC3 inv6 env s0 carInFront'value peCarUnder'value opened'value closed'value"
  apply(unfold VC3_def inv6_def R6_def)
  apply(rule impI)
  apply(rule context_conjI)
...
theorem  "VC14 inv6 env s0 carInFront'value peCarUnder'value opened'value closed'value"
  apply(unfold VC14_def inv6_def R6_def)
  apply(rule impI)
  apply(rule context_conjI)
...
theorem  "VC15 inv6 env s0 carInFront'value peCarUnder'value opened'value closed'value"
  apply(unfold VC15_def inv6_def R6_def)
  apply(rule impI)
  apply(rule context_conjI)
...
theorem  "VC16 inv6 env s0 carInFront'value peCarUnder'value opened'value closed'value"
  apply(unfold VC16_def inv6_def R6_def)
  apply(rule impI)
  apply(rule context_conjI)
...
theorem  "VC17 inv6 env s0 carInFront'value peCarUnder'value opened'value closed'value"
  apply(unfold VC17_def inv6_def R6_def)
  apply(rule impI)
  apply(rule context_conjI)
...
theorem  "VC18 inv6 env s0 carInFront'value peCarUnder'value opened'value closed'value"
  apply(unfold VC18_def inv6_def R6_def)
  apply(rule impI)
  apply(rule context_conjI)
...
theorem  "VC19 inv6 env s0 carInFront'value peCarUnder'value opened'value closed'value"
  apply(unfold VC19_def inv6_def R6_def)
  apply(rule impI)
  apply(rule context_conjI)
...
theorem  "VC20 inv6 env s0 carInFront'value peCarUnder'value opened'value closed'value"
  apply(unfold VC20_def inv6_def R6_def)
  apply(rule impI)
  apply(rule context_conjI)
...
theorem  "VC21 inv6 env s0 carInFront'value peCarUnder'value opened'value closed'value"
  apply(unfold VC21_def inv6_def R6_def)
  apply(rule impI)
  apply(rule context_conjI)
...
theorem  "VC22 inv6 env s0 carInFront'value peCarUnder'value opened'value closed'value"
  apply(unfold VC22_def inv6_def R6_def)
  apply(rule impI)
  apply(rule context_conjI)
...
theorem  "VC23 inv6 env s0 carInFront'value peCarUnder'value opened'value closed'value"
  apply(unfold VC23_def inv6_def R6_def)
  apply(rule impI)
  apply(rule context_conjI)
...
theorem  "VC24 inv6 env s0 carInFront'value peCarUnder'value opened'value closed'value"
  apply(unfold VC24_def inv6_def R6_def)
  apply(rule impI)
  apply(rule context_conjI)
...
theorem  "VC25 inv6 env s0 carInFront'value peCarUnder'value opened'value closed'value"
  apply(unfold VC25_def inv6_def R6_def)
  apply(rule impI)
  apply(rule context_conjI)
...
theorem  "VC26 inv6 env s0 carInFront'value peCarUnder'value opened'value closed'value"
  apply(unfold VC26_def inv6_def R6_def)
  apply(rule impI)
  apply(rule context_conjI)
...
theorem  "VC27 inv6 env s0 carInFront'value peCarUnder'value opened'value closed'value"
  apply(unfold VC27_def inv6_def R6_def)
  apply(rule impI)
  apply(rule context_conjI)
...
theorem  "VC28 inv6 env s0 carInFront'value peCarUnder'value opened'value closed'value"
  apply(unfold VC28_def inv6_def R6_def)
  apply(rule impI)
  apply(rule context_conjI)
...
theorem  "VC29 inv6 env s0 carInFront'value peCarUnder'value opened'value closed'value"
  apply(unfold VC29_def inv6_def R6_def)
  apply(rule impI)
  apply(rule context_conjI)
...
theorem  "VC30 inv6 env s0 carInFront'value peCarUnder'value opened'value closed'value"
  apply(unfold VC30_def inv6_def R6_def)
  apply(rule impI)
  apply(rule context_conjI)
...
theorem  "VC31 inv6 env s0 carInFront'value peCarUnder'value opened'value closed'value"
  apply(unfold VC31_def inv6_def R6_def)
  apply(rule impI)
  apply(rule context_conjI)
...
theorem  "VC32 inv6 env s0 carInFront'value peCarUnder'value opened'value closed'value"
  apply(unfold VC32_def inv6_def R6_def)
  apply(rule impI)
  apply(rule context_conjI)
...
theorem  "VC33 inv6 env s0 carInFront'value peCarUnder'value opened'value closed'value"
  apply(unfold VC33_def inv6_def R6_def)
  apply(rule impI)
  apply(rule context_conjI)
...
theorem  "VC34 inv6 env s0 carInFront'value peCarUnder'value opened'value closed'value"
  apply(unfold VC34_def inv6_def R6_def)
  apply(rule impI)
  apply(rule context_conjI)
...
theorem  "VC35 inv6 env s0 carInFront'value peCarUnder'value opened'value closed'value"
  apply(unfold VC35_def inv6_def R6_def)
  apply(rule impI)
  apply(rule context_conjI)
