theory Proofs_R10
  imports ExtraInv_R10 Requirements
begin

definition inv10 where "inv10 s \<equiv> extraInv s \<and> R10 s"
...
theorem extra729: "VC729 extraInv env s0 button1'value button2'value deposited'value given1'value given2'value paidOut'value
 cancel'value "
apply(unfold VC729_def extraInv_def)
 apply(rule impI)
  apply(rule conjI)
...
theorem  "VC1 inv10 s0"
  apply(unfold VC1_def inv10_def R10_def P4'_def always2_def constrained_until_def
always_def previous_ex_def)
  using extra1 VC1_def  apply auto
  done

theorem  "VC72 inv10 env s0  button1'value button2'value deposited'value given1'value given2'value paidOut'value
 cancel'value"
  apply(unfold VC72_def inv10_def R10_def)
  apply(rule impI)
...
theorem  "VC153 inv10 env s0  button1'value button2'value deposited'value given1'value given2'value paidOut'value
 cancel'value"
  apply(unfold VC153_def inv10_def R10_def)
  apply(rule impI)
  apply(rule context_conjI)
...
theorem  "VC315 inv10 env s0  button1'value button2'value deposited'value given1'value given2'value paidOut'value
 cancel'value"
  apply(unfold VC315_def inv10_def R10_def)
  apply(rule impI)
  apply(rule context_conjI)
...
theorem  "VC324 inv10 env s0  button1'value button2'value deposited'value given1'value given2'value paidOut'value
 cancel'value"
  apply(unfold VC324_def inv10_def R10_def)
  apply(rule impI)
  apply(rule context_conjI)
...
theorem  "VC333 inv10 env s0  button1'value button2'value deposited'value given1'value given2'value paidOut'value
 cancel'value"
  apply(unfold VC333_def inv10_def R10_def)
  apply(rule impI)
  apply(rule context_conjI)
...
theorem  "VC342 inv10 env s0  button1'value button2'value deposited'value given1'value given2'value paidOut'value
 cancel'value"
  apply(unfold VC342_def inv10_def R10_def)
  apply(rule impI)
  apply(rule context_conjI)
...
theorem  "VC351 inv10 env s0  button1'value button2'value deposited'value given1'value given2'value paidOut'value
 cancel'value"
  apply(unfold VC351_def inv10_def R10_def)
  apply(rule impI)
  apply(rule context_conjI)
...
theorem  "VC360 inv10 env s0  button1'value button2'value deposited'value given1'value given2'value paidOut'value
 cancel'value"
  apply(unfold VC360_def inv10_def R10_def)
  apply(rule impI)
  apply(rule context_conjI)
...
theorem  "VC369 inv10 env s0  button1'value button2'value deposited'value given1'value given2'value paidOut'value
 cancel'value"
  apply(unfold VC369_def inv10_def R10_def)
  apply(rule impI)
  apply(rule context_conjI)
...
theorem  "VC378 inv10 env s0  button1'value button2'value deposited'value given1'value given2'value paidOut'value
 cancel'value"
  apply(unfold VC378_def inv10_def R10_def)
  apply(rule impI)
  apply(rule context_conjI)
...
theorem  "VC387 inv10 env s0  button1'value button2'value deposited'value given1'value given2'value paidOut'value
 cancel'value"
  apply(unfold VC387_def inv10_def R10_def)
  apply(rule impI)
  apply(rule context_conjI)
...
theorem  "VC396 inv10 env s0  button1'value button2'value deposited'value given1'value given2'value paidOut'value
 cancel'value"
  apply(unfold VC396_def inv10_def R10_def)
  apply(rule impI)
  apply(rule context_conjI)
...
theorem  "VC405 inv10 env s0  button1'value button2'value deposited'value given1'value given2'value paidOut'value
 cancel'value"
  apply(unfold VC405_def inv10_def R10_def)
  apply(rule impI)
  apply(rule context_conjI)
...
theorem  "VC738 inv10 env s0  button1'value button2'value deposited'value given1'value given2'value paidOut'value
 cancel'value"
  apply(unfold VC738_def inv10_def R10_def)
  apply(rule impI)
  apply(rule context_conjI)
...
theorem  "VC747 inv10 env s0  button1'value button2'value deposited'value given1'value given2'value paidOut'value
 cancel'value"
  apply(unfold VC747_def inv10_def R10_def)
  apply(rule impI)
  apply(rule context_conjI)
...
theorem  "VC756 inv10 env s0  button1'value button2'value deposited'value given1'value given2'value paidOut'value
 cancel'value"
  apply(unfold VC756_def inv10_def R10_def)
  apply(rule impI)
  apply(rule context_conjI)
...
theorem  "VC765 inv10 env s0  button1'value button2'value deposited'value given1'value given2'value paidOut'value
 cancel'value"
  apply(unfold VC765_def inv10_def R10_def)
  apply(rule impI)
  apply(rule context_conjI)
...
theorem  "VC774 inv10 env s0  button1'value button2'value deposited'value given1'value given2'value paidOut'value
 cancel'value"
  apply(unfold VC774_def inv10_def R10_def)
  apply(rule impI)
  apply(rule context_conjI)
...
theorem  "VC783 inv10 env s0  button1'value button2'value deposited'value given1'value given2'value paidOut'value
 cancel'value"
  apply(unfold VC783_def inv10_def R10_def)
  apply(rule impI)
  apply(rule context_conjI)
...
theorem  "VC792 inv10 env s0  button1'value button2'value deposited'value given1'value given2'value paidOut'value
 cancel'value"
  apply(unfold VC792_def inv10_def R10_def)
  apply(rule impI)
  apply(rule context_conjI)
...
theorem  "VC801 inv10 env s0  button1'value button2'value deposited'value given1'value given2'value paidOut'value
 cancel'value"
  apply(unfold VC801_def inv10_def R10_def)
  apply(rule impI)
  apply(rule context_conjI)
...
theorem  "VC810 inv10 env s0  button1'value button2'value deposited'value given1'value given2'value paidOut'value
 cancel'value"
  apply(unfold VC810_def inv10_def R10_def)
  apply(rule impI)
  apply(rule context_conjI)
...
theorem  "VC639 inv10 env s0  button1'value button2'value deposited'value given1'value given2'value paidOut'value
 cancel'value"
  apply(unfold VC639_def inv10_def R10_def)
  apply(rule impI)
  apply(rule context_conjI)
...
theorem  "VC882 inv10 env s0  button1'value button2'value deposited'value given1'value given2'value paidOut'value
 cancel'value"
  apply(unfold VC882_def inv10_def R10_def)
  apply(rule impI)
  apply(rule context_conjI)
...
theorem  "VC963 inv10 env s0  button1'value button2'value deposited'value given1'value given2'value paidOut'value
 cancel'value"
  apply(unfold VC963_def inv10_def R10_def)
  apply(rule impI)
  apply(rule context_conjI)
...
theorem  "VC729 inv10 env s0  button1'value button2'value deposited'value given1'value given2'value paidOut'value
 cancel'value"
  apply(unfold VC729_def inv10_def R10_def)
  apply(rule impI)
  apply(rule context_conjI)
